  ...
  export default function Component() {
    ...
    const renderSidebarItem = (item: SidebarItem, index: number) => (
      <div key={item.name} className="space-y-1">
        <Button
          variant="ghost"
          className={`w-full justify-start text-left hover:bg-gray-800 hover:text-white dark:hover:bg-gray-700 dark:hover:text-gray-200 ${expandedSections.has(item.name) ? 'bg-gray-800 text-white dark:bg-gray-700 dark:text-gray-200' : 'text-gray-400 dark:text-gray-400'}`}
          onClick={() => {
          ...
          <div className="ml-6 space-y-1">
            {item.subitems?.map((subitem: string | { name: string; special?: boolean }) => (
              <Button
                ...
                variant="ghost"
                className={`w-full justify-start text-left text-sm py-1 px-2 h-auto hover:bg-gray-800 hover:text-white dark:hover:bg-gray-700 dark:hover:text-gray-200 ${typeof subitem !== 'string' && subitem.special ? 'text-blue-400 hover:text-blue-300 dark:text-blue-300 dark:hover:text-blue-400' : 'text-gray-400 dark:text-gray-400'}`}
                onClick={() => {
          ...
          <div className="grid grid-cols-3 gap-6 bg-white dark:bg-gray-800">
            <Card className="bg-white border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-600">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-gray-800 dark:text-white text-lg font-semibold">Quick Insights</CardTitle>
                <Button variant="ghost" size="icon" className="text-gray-400 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
          ...
          <div className="flex-1 overflow-hidden flex bg-white dark:bg-gray-800">
            <div className="flex-1 flex flex-col overflow-hidden">
              <ScrollArea className="flex-1 p-6 text-gray-900 dark:text-gray-200">
                    ...
                    <div className="space-y-4">
                      ...
                      <form onSubmit={handleSendMessage} className="flex space-x-2">
                        <Input
                          ...
                          className="flex-grow bg-white-800 border-gray-200 text-black dark:bg-gray-600 dark:border-gray-500"
                        />
                ...
                <Card className="bg-white-800 border-gray-200 mb-6 dark:bg-gray-800 dark:border-gray-700">
                  <CardHeader>
                    <CardTitle className="text-xl text-black dark:text-gray-200">Automation Configuration</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-white-300 dark:text-gray-200">Report Frequency</label>
                      <Select value={frequency} onValueChange={setFrequency}>
                        <SelectTrigger className="w-full bg-white-800 border-gray-200 text-black dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-black-300 dark:text-gray-200">Included Data Sources</label>
                        ...
                        {['Email Campaigns', 'Social Media', 'Website Analytics', 'CRM Data'].map((source) => (
                          <div key={source} className="flex items-center space-x-2">
                            ...
                            <label
                              ...
                              className="text-sm text-black-300 dark:text-gray-200"
                            >
                              {source}
                            </label>
                          </div>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-black-300 dark:text-gray-200">Report Recipients</label>
                      <Textarea
                ...
                <Card className="bg-white-800 border-white-800 dark:bg-gray-800 dark:border-gray-700">
                  <CardHeader>
                    <CardTitle className="text-xl text-black dark:text-gray-200">Automation Workflow</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-black dark:text-gray-200">1. Collect data from configured sources</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="bg-green-600 rounded-full p-2">
                          <Search className="h-5 w-5 text-white" />
                        </div>
                        <span className="text-black dark:text-gray-200">2. Analyze messaging effectiveness</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="bg-yellow-600 rounded-full p-2">
                          <FileText className="h-5 w-5 text-white" />
                        </div>
                        <span className="text-black dark:text-gray-200">3. Generate comprehensive report</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="bg-purple-600 rounded-full p-2">
                          <Mail className="h-5 w-5 text-white" />
                        </div>
                        <span className="text-black dark:text-gray-200">4. Distribute report to recipients</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
    ...
    const renderEmailMessageResonanceReport = () => (
      <div className="flex h-screen bg-white-950 text-gray-800 font-sans dark:bg-gray-950 dark:text-gray-200">
        <main className="flex-1 overflow-auto relative w-full">
            ...
            <header className="flex justify-between items-center mb-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <Button
                  ...
                  className="bg-white-800 text-black border-gray-200 hover:bg-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700"
                >
          ...
          <div className="px-8 pb-8 flex space-x-6 bg-white-950 dark:bg-gray-800 ">
            ...
            <Card className={`flex-1 bg-white text-gray-900 transition-all duration-300 ease-in-out dark:bg-gray-800 dark:text-gray-200 ${isRightSidebarExpanded ? 'mr-96' : ''}`}>
              <CardHeader>
